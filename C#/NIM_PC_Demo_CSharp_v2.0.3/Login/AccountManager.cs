...
namespace NIMDemo
{
    [XmlRootAttribute("Account", IsNullable = false)]
    ...
    [XmlRootAttribute("NIMAccounts", IsNullable = false)]
    ...
    {
        private static string SettingFilePath = "Accounts.xml";
        private static string DESKey = "nim1.7.0";
        private static string DESIV = "1.7.0nim";
