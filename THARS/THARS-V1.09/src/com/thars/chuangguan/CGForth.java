...
public class CGForth extends Activity implements OnClickListener{
	...
	public void set_show(){
		...
		QuesOperate user_name_qo = new QuesOperate(CGForth.this);
	...
	public void onClick(View v) {
		...
		case R.id.category_ans_a:
			...
			if(loop<loop_end){
				...
				{Toast.makeText(CGForth.this, "duang~,答对了~", Toast.LENGTH_LONG).show();
				point = point+1;}
				else
				Toast.makeText(CGForth.this, "好遗憾->_->", Toast.LENGTH_LONG).show();
	//			anime_delay(delay_time);
				...
				if(point > 8)
		        intent.setClass(CGForth.this, CGSuccess4.class);
				else
					intent.setClass(CGForth.this, CGFailure4.class);
