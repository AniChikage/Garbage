...
public class CGFailure3 extends Activity {
...
/*
	...
	class cgfreturn implements OnClickListener{
		...
		public void onClick(View v) {
	        ...
	        intent.setClass(CGFailure3.this, CGintro.class);
	...
	class cgfretry implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGFailure3.this, CGThird.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGFailure3.this);
			...
			new AlertDialog.Builder(CGFailure3.this)
            .setTitle("OK")
