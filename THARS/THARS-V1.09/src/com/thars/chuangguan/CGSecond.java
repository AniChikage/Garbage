...
public class CGSecond extends Activity implements OnClickListener{
	...
	public void set_show(){
		...
		QuesOperate user_name_qo = new QuesOperate(CGSecond.this);
	...
	public void onClick(View v) {
		...
		case R.id.category_ans_a:
			...
			if(loop<loop_end){
				...
				{Toast.makeText(CGSecond.this, "duang~,答对了~", Toast.LENGTH_LONG).show();
				point = point+1;}
				else
				Toast.makeText(CGSecond.this, "好遗憾->_->", Toast.LENGTH_LONG).show();
	//			anime_delay(delay_time);
				...
				if(point > 6)
		        intent.setClass(CGSecond.this, CGSuccess2.class);
				else
					intent.setClass(CGSecond.this, CGFailure2.class);
