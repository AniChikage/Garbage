...
public class CGSuccess2 extends Activity {
...
/*
	...
	class cgsreturn implements OnClickListener{
		...
		public void onClick(View v) {
	        ...
	        intent.setClass(CGSuccess2.this, CGintro.class);
	...
	class cgsnext implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGSuccess2.this, Third.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGSuccess2.this);
			...
			new AlertDialog.Builder(CGSuccess2.this)
            .setTitle("OK")
