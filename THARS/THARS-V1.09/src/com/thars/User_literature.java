...
public class User_literature extends Activity implements OnClickListener{
	...
	//	startTimer();
		...
		QuesOperate user_name_qo = new QuesOperate(User_literature.this);
	...
	public void onClick(View v) {
		...
		case R.id.category_ans_a:
			...
			if(loop<loop_end){
				...
				{Toast.makeText(User_literature.this, "duang~,答对了~", Toast.LENGTH_LONG).show();
				point = point+1;}
				else
				Toast.makeText(User_literature.this, "好遗憾->_->", Toast.LENGTH_LONG).show();
	//			anime_delay(delay_time);
		        ...
		        intent.setClass(User_literature.this, Result.class);
    	...
    	//			anime_delay(delay_time);
        	...
        	case R.id.returncategory:
        		Intent intent = new Intent();
		        intent.setClass(User_literature.this, Category.class);
		        startActivity(intent);
		        break;
		default:
			break;
