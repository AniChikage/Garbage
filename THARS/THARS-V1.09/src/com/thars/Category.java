...
public class Category extends Activity {
	...
	private Button btn_setting,btn_return;
	//private int time;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_return = (Button)findViewById(R.id.category_return);
		...
		btn_return.setOnClickListener(new category_return_OnClickListener());
	}
	...
	class category_return_OnClickListener implements OnClickListener{
		@Override
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(Category.this, Selection.class);
	        startActivity(intent);
