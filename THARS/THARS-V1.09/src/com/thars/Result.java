...
public class Result extends Activity {
    ...
    private Button btn_anime_return_category,btn_clear;
    public int result;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_anime_return_category = (Button)findViewById(R.id.anime_return_category);
		btn_clear = (Button)findViewById(R.id.anime_clear);
		anime_result = (TextView)findViewById(R.id.anime_result_mes);
		anime_result1 = (TextView)findViewById(R.id.anime_result_mes1);
		anime_result2 = (TextView)findViewById(R.id.anime_result_mes2);
		anime_result3 = (TextView)findViewById(R.id.anime_result_mes3);
    ...
    //	anime_result3.setText(String.valueOf(temp2));
    	...
    	btn_anime_return_category.setOnClickListener(new anime_return_category_Click());
    	btn_clear.setOnClickListener(new anime_return_model_Click());

	}
	class anime_return_category_Click implements OnClickListener{
		@Override
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(Result.this, Category.class);
	        startActivity(intent);
			
		}
	}
	class anime_return_model_Click implements OnClickListener{
		@Override
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(Result.this, Selection.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(Result.this);
