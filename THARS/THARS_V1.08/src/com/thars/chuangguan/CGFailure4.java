...
public class CGFailure4 extends Activity {
...
/*
	...
	class cgfreturn implements OnClickListener{
		...
		public void onClick(View v) {
	        ...
	        intent.setClass(CGFailure4.this, CGintro.class);
	...
	class cgfretry implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGFailure4.this, CGForth.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGFailure4.this);
			...
			new AlertDialog.Builder(CGFailure4.this)
            .setTitle("OK")
