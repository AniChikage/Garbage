...
public class CGResult extends Activity {
    ...
    //	anime_result3.setText(String.valueOf(temp2));
    	...
    	btn_clear.setOnClickListener(new anime_clear_Click());
	...
	class anime_return_category_Click implements OnClickListener{
		...
		public void onClick(View v) {
	        ...
	        intent.setClass(CGResult.this, First.class);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGResult.this);
			...
			new AlertDialog.Builder(CGResult.this)
            .setTitle("OK")
