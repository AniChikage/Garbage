...
public class CGSuccess1 extends Activity {
	...
	class cgsreturn implements OnClickListener{
		...
		public void onClick(View v) {
	        ...
	        intent.setClass(CGSuccess1.this, CGintro.class);
	...
	class cgsnext implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGSuccess1.this, Second.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGSuccess1.this);
			...
			new AlertDialog.Builder(CGSuccess1.this)
            .setTitle("OK")
