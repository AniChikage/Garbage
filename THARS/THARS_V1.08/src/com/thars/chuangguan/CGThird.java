...
public class CGThird extends Activity implements OnClickListener{
	...
	public void set_show(){
		...
		QuesOperate user_name_qo = new QuesOperate(CGThird.this);
	...
	public void onClick(View v) {
		...
		case R.id.category_ans_a:
			...
			if(loop<loop_end){
				...
				{Toast.makeText(CGThird.this, "duang~,答对了~", Toast.LENGTH_LONG).show();
				point = point+1;}
				else
				Toast.makeText(CGThird.this, "好遗憾->_->", Toast.LENGTH_LONG).show();
	//			anime_delay(delay_time);
				...
				if(point > 7)
		        intent.setClass(CGThird.this, CGSuccess3.class);
				else
					intent.setClass(CGThird.this, CGFailure3.class);
