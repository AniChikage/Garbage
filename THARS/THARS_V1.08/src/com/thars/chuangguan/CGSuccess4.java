...
public class CGSuccess4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cgsuccess);
        
		cgbtn_next = (Button)findViewById(R.id.cgsnext);
		cgbtn_return = (Button)findViewById(R.id.cgsreturn);
		
		cgbtn_next.setText("成功！");
...
/*
    ...
    //	anime_result3.setText(String.valueOf(temp2));
     ...
     //   cgbtn_next.setOnClickListener(new anime_return_category_Click());
        cgbtn_return.setOnClickListener(new cgsreturn());
        cgbtn_next.setOnClickListener(new cgsnext());

	}
	class cgsreturn implements OnClickListener{
		@Override
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGSuccess4.this, CGintro.class);
	        startActivity(intent);
			
		}
	}
	class cgsnext implements OnClickListener{
		@Override
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGSuccess4.this, CGWin.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGSuccess4.this);
			...
			new AlertDialog.Builder(CGSuccess4.this)
            .setTitle("OK")
