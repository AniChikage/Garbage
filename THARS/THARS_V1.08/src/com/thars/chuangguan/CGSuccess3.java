...
public class CGSuccess3 extends Activity {
...
/*
	...
	class cgsreturn implements OnClickListener{
		...
		public void onClick(View v) {
	        ...
	        intent.setClass(CGSuccess3.this, CGintro.class);
	...
	class cgsnext implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent();
	        intent.setClass(CGSuccess3.this, Forth.class);
	        startActivity(intent);
	...
	class anime_clear_Click implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			QuesOperate computer_db_qo = new QuesOperate(CGSuccess3.this);
			...
			new AlertDialog.Builder(CGSuccess3.this)
            .setTitle("OK")
